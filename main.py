...
def main(video_input_path='input_videos/too.mp4', model_path = 'models/best.pt', output_video_path = 'output_videos/output_video.avi'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_input_path', type=str, default='input_videos/too.mp4', help='Path to the input video file')
